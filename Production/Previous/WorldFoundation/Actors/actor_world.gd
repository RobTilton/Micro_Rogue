extends RefCounted
const Maps = preload("res://Production/Previous/WorldFoundation/World/map_world.gd")
...
const Clock = preload("res://Production/Previous/WorldFoundation/Actors/cooldowns.gd")
const Sight = preload("res://Production/Previous/WorldFoundation/Actors/perception.gd")
var maps: RefCounted
