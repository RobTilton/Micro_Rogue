extends "res://Production/Previous/WorldFoundation/UI/hex_board.gd"
...
const WastelandArt = preload("res://Production/Previous/WorldFoundation/UI/wasteland_art.gd")
var wasteland_textures: Array[Texture2D] = []
const MarshArt = preload("res://Production/Previous/WorldFoundation/UI/marsh_art.gd")
...
const Biomes = preload("res://Production/Previous/WorldFoundation/World/biome_generator.gd")
const PoiArt = preload("res://Production/Previous/WorldFoundation/UI/poi_art.gd")
var poi_texture: Texture2D
var biome_texture: Texture2D
const RiverArt = preload("res://Production/Previous/WorldFoundation/UI/river_art.gd")
