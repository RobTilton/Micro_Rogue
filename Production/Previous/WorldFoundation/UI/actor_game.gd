extends "res://Production/Previous/WorldFoundation/UI/game_ui.gd"
const Simulation = preload("res://Production/Previous/WorldFoundation/Actors/actor_world.gd")
const Brain = preload("res://Production/Previous/WorldFoundation/Actors/enemy_brain.gd")
const ActorView = preload("res://Production/Previous/WorldFoundation/UI/actor_view.gd")
