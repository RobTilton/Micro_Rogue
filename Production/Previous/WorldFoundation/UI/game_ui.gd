extends "res://Production/Previous/WorldFoundation/UI/base_game.gd"
const Card = preload("res://Production/Previous/WorldFoundation/UI/item_card.gd")
const Inspection = preload("res://Production/Previous/WorldFoundation/Actors/item_inspection.gd")
const Grid = preload("res://Production/Previous/WorldFoundation/Actors/grid_inventory.gd")
const Paths = preload("res://Production/Previous/WorldFoundation/World/movement_preview.gd")
const Parts = preload("res://Production/Previous/WorldFoundation/UI/ui_parts.gd")
const Rail = preload("res://Production/Previous/WorldFoundation/UI/navigation_rail.gd")
const Host = preload("res://Production/Previous/WorldFoundation/UI/panel_host.gd")
const Hud = preload("res://Production/Previous/WorldFoundation/UI/bottom_hud.gd")
const World = preload("res://Production/Previous/WorldFoundation/UI/world_view.gd")
const BackpackGrid = preload("res://Production/Previous/WorldFoundation/UI/inventory_grid.gd")
const Target = preload("res://Production/Previous/WorldFoundation/UI/item_target.gd")
const Drag = preload("res://Production/Previous/WorldFoundation/UI/drag_context.gd")
const MapWorld = preload("res://Production/Previous/WorldFoundation/World/map_world.gd")
const Travel = preload("res://Production/Previous/WorldFoundation/World/travel_cost.gd")
var map_world = null
var active_map = null
