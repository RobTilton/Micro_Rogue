extends "res://Production/Previous/WorldFoundation/Actors/actor_world.gd"
const Locations = preload("res://Production/Previous/WorldFoundation/World/location_world.gd")
...
const Items = preload("res://Production/Previous/WorldFoundation/Actors/items.gd")
const MapState = preload("res://Production/Previous/WorldFoundation/Persistence/map_state.gd")
