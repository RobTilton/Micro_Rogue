extends RefCounted
const HexMap = preload("res://Production/Previous/WorldFoundation/World/hex_map.gd")
const Biomes = preload("res://Production/Previous/WorldFoundation/World/biome_generator.gd")
const Continents = preload("res://Production/Previous/WorldFoundation/World/continent_generator.gd")
const LocalTerrain = preload("res://Production/Previous/WorldFoundation/World/local_terrain.gd")
...
const LocalPois = preload("res://Production/Previous/WorldFoundation/World/local_poi_placement.gd")
var world_seed: int
var maps: Dictionary = {}
