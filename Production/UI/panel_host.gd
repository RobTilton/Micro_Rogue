...
const PANEL_SIZES: Dictionary = {"Tile":Vector2(390,350),"Look":Vector2(520,480),"Character":Vector2(390,430),"Inventory":Vector2(710,840),"Skills":Vector2(850,780),"Logs":Vector2(620,460),"Options":Vector2(430,350),"Activate":Vector2(430,480)}
