extends RefCounted
const ART_ROOT: String = "res://Production/Assets/Items/"
...
static func quality_color(item: Dictionary, known: bool = true) -> Color:
	...
	if item.has("quality"):
		return {"trash":Color("888888"),"common":Color("ffffff"),"exceptional":Color("63be72"),"masterwork":Color("619fe5"),"mythic":Color("b77cde"),"touched_by_the_gods":Color("f09940")}.get(item.quality.id,Color.WHITE)
