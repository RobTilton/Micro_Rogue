...
static func quality(enemy: bool) -> int:
	...
	return 0
static func make(kind: String, enemy: bool = false) -> Dictionary:
	var rarity: int = quality(enemy)
	var item: Dictionary = {"kind": kind, "rarity": rarity, "bonus": BONUS[rarity], "die": 0, "name": "", "contents": [], "capacity": 0}
	match kind:
		"sword":
			item.die = 4
