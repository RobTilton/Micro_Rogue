...
const Actors = preload("res://Production/Gameplay/actors.gd")
const Combat = preload("res://Production/Gameplay/combat.gd")
const Inventory = preload("res://Production/Gameplay/inventory.gd")
const Board = preload("res://Production/Gameplay/hex_board.gd")
const DieSlot = preload("res://Production/Gameplay/die_slot.gd")
const SplashArt = preload("res://Production/Splash/splash_art.gd")
...
func _creation_ui() -> void:
	...
	_button(root, "Confirm character and enter arena", _start_run, assigned)
...
func _end_turn() -> void:
	...
	for step: int in range(3 + enemy.stats.DEX):
		...
		var best: Vector2i = enemy.pos
		for direction: Vector2i in Combat.DIRECTIONS:
			var next: Vector2i = enemy.pos + direction
