extends "res://Production/Current/gameplay/main.gd"
const Card = preload("res://Production/Current/ui/item_card.gd")
...
const Paths = preload("res://Production/Current/domain/movement_preview.gd")
const Parts = preload("res://Production/Current/ui/ui_parts.gd")
const Rail = preload("res://Production/Current/ui/navigation_rail.gd")
const Host = preload("res://Production/Current/ui/panel_host.gd")
const Hud = preload("res://Production/Current/ui/bottom_hud.gd")
const World = preload("res://Production/Current/ui/world_view.gd")
const BackpackGrid = preload("res://Production/Current/ui/inventory_grid.gd")
const Target = preload("res://Production/Current/ui/item_target.gd")
const Drag = preload("res://Production/Current/ui/drag_context.gd")
const MapWorld = preload("res://Production/Current/domain/map_world.gd")
var map_world = null
var active_map = null
