extends Control
const Cooldowns = preload("res://Production/Current/gameplay/cooldowns.gd")
const SKILL_COOLDOWNS: Dictionary = {"Lunge": 4, "Riposte": 2}
const Actors = preload("res://Production/Current/gameplay/actors.gd")
const Combat = preload("res://Production/Current/gameplay/combat.gd")
const Inventory = preload("res://Production/Current/gameplay/inventory.gd")
const Board = preload("res://Production/Current/gameplay/hex_board.gd")
const DieSlot = preload("res://Production/Current/gameplay/die_slot.gd")
const SplashArt = preload("res://Production/Current/splash/splash_art.gd")
