...
const Continents = preload("res://Production/World/continent_generator.gd")
const LocalTerrain = preload("res://Production/World/local_terrain.gd")
const Water = preload("res://Production/World/local_water.gd")
const Rivers = preload("res://Production/World/river_generator.gd")
const LocalPois = preload("res://Production/World/local_poi_placement.gd")
var world_seed: int
var maps: Dictionary = {}
