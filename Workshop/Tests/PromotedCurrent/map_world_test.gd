...
func run() -> void:
	...
	check(game.active_map.links.size() == 25,"every global hex links to local")
	game._enter_map()
	...
	game._enter_map()
	check(game.battle and game.active_map.dimensions == Vector2i(9,7),"dungeon encounter and extent")
