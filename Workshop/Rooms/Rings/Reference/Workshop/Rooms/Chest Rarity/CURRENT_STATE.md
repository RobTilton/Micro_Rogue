...
Read `Workshop/Micro_Rogue_Rings_And_Amulets.md` fully. Rings tune existing systems; amulets introduce rule changes. The document's standard amulet target is 0.05% from Rare Chests. User explicitly specified chest mix: 75% normal, 25% rare. This delivery implements the chest classification only; jewelry generation, slots/effects, ring drop tables and amulet rolls remain pending.
