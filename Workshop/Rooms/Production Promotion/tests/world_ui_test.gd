...
func check(value: bool, message: String) -> void:
	...
	if not value:
		failures += 1
		push_error("Workshop/Rooms/Production Promotion/tests/world_ui_test.gd: "+message)
...
func run() -> void:
	...
	var saved: Dictionary = game.simulation.save_game("res://Workshop/Rooms/Production Promotion/tests/saves/")
