...
func run() -> void:
	...
	var dir: String = "res://Workshop/Rooms/Playtest Refinement/tests/saves/"
	...
	if DisplayServer.get_name() != "headless":
		...
		root.get_texture().get_image().save_png("res://Workshop/Rooms/Playtest Refinement/controls.png")
	game._toggle_panel("Options",160)
	...
	if DisplayServer.get_name() != "headless":
		await process_frame
		await RenderingServer.frame_post_draw
		root.get_texture().get_image().save_png("res://Workshop/Rooms/Playtest Refinement/tests/sidebar.png")
