extends "res://Workshop/Rooms/Regional Release/Actors/actor_world.gd"
const Locations = preload("res://Workshop/Rooms/Regional Release/World/location_world.gd")
...
const Items = preload("res://Workshop/Rooms/Regional Release/Actors/items.gd")
const MapState = preload("res://Workshop/Rooms/Regional Release/Persistence/map_state.gd")
