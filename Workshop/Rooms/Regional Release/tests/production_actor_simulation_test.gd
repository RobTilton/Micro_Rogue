...
func check(value: bool, description: String) -> void:
	checks += 1
	if not value:
		push_error("Workshop/Rooms/Regional Release/tests/actor_simulation_test.gd: " + description)
		failures += 1
func fixture() -> void:
	world.actors.clear()
...
func _initialize() -> void:
	...
	print("Workshop/Rooms/Regional Release/tests/actor_simulation_test.gd: %d checks, %d failures" % [checks,failures])
