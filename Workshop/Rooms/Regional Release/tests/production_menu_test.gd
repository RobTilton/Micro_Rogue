...
func run() -> void:
	...
	var directory: String = "res://Workshop/Rooms/Regional Release/tests/production_menu_slot/"
	...
	check(root.get_texture().get_image().save_png("res://Workshop/Rooms/Regional Release/tests/production_start_menu.png") == OK,"menu capture")
