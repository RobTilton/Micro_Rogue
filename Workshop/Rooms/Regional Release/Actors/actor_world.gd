extends RefCounted
const Maps = preload("res://Workshop/Rooms/Regional Release/World/map_world.gd")
const Actors = preload("res://Workshop/Rooms/Regional Release/Actors/actors.gd")
const Combat = preload("res://Workshop/Rooms/Regional Release/Actors/combat.gd")
const Inventory = preload("res://Workshop/Rooms/Regional Release/Actors/inventory.gd")
...
const Clock = preload("res://Workshop/Rooms/Regional Release/Actors/cooldowns.gd")
const Sight = preload("res://Workshop/Rooms/Regional Release/Actors/perception.gd")
var maps: RefCounted
...
func add_actor(actor: Dictionary, map_id: String, cell: Vector2i, faction: String, sprite: String = "goblin") -> int:
	assert(maps.maps.has(map_id) and maps.maps[map_id].walkable(cell) and actor_at(map_id,cell).is_empty(), "Workshop/Rooms/Regional Release/Actors/actor_world.gd: invalid or occupied actor spawn")
	var id: int = next_id
	next_id += 1
