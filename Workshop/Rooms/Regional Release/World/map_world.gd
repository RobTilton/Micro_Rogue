extends RefCounted
const HexMap = preload("res://Workshop/Rooms/Regional Release/World/hex_map.gd")
const Biomes = preload("res://Workshop/Rooms/Regional Release/World/biome_generator.gd")
const Continents = preload("res://Workshop/Rooms/Regional Release/World/continent_generator.gd")
const LocalTerrain = preload("res://Workshop/Rooms/Regional Release/World/local_terrain.gd")
...
const LocalPois = preload("res://Workshop/Rooms/Regional Release/World/local_poi_placement.gd")
var world_seed: int
var maps: Dictionary = {}
