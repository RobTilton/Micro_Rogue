extends "res://Workshop/Rooms/Regional Release/UI/hex_board.gd"
...
const WastelandArt = preload("res://Workshop/Rooms/Regional Release/UI/wasteland_art.gd")
var wasteland_textures: Array[Texture2D] = []
const MarshArt = preload("res://Workshop/Rooms/Regional Release/UI/marsh_art.gd")
...
const PoiArt = preload("res://Workshop/Rooms/Regional Release/UI/poi_art.gd")
var poi_texture: Texture2D
var biome_texture: Texture2D
const RiverArt = preload("res://Workshop/Rooms/Regional Release/UI/river_art.gd")
