extends Control
const Cooldowns = preload("res://Workshop/Rooms/Regional Release/Actors/cooldowns.gd")
...
const Board = preload("res://Workshop/Rooms/Regional Release/UI/hex_board.gd")
const DieSlot = preload("res://Workshop/Rooms/Regional Release/UI/die_slot.gd")
const SplashArt = preload("res://Workshop/Rooms/Regional Release/UI/splash_art.gd")
