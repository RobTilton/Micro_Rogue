extends "res://Workshop/Rooms/Regional Release/UI/base_game.gd"
const Card = preload("res://Workshop/Rooms/Regional Release/UI/item_card.gd")
const Inspection = preload("res://Workshop/Rooms/Regional Release/Actors/item_inspection.gd")
const Grid = preload("res://Workshop/Rooms/Regional Release/Actors/grid_inventory.gd")
const Paths = preload("res://Workshop/Rooms/Regional Release/World/movement_preview.gd")
const Parts = preload("res://Workshop/Rooms/Regional Release/UI/ui_parts.gd")
const Rail = preload("res://Workshop/Rooms/Regional Release/UI/navigation_rail.gd")
const Host = preload("res://Workshop/Rooms/Regional Release/UI/panel_host.gd")
const Hud = preload("res://Workshop/Rooms/Regional Release/UI/bottom_hud.gd")
const World = preload("res://Workshop/Rooms/Regional Release/UI/world_view.gd")
const BackpackGrid = preload("res://Workshop/Rooms/Regional Release/UI/inventory_grid.gd")
const Target = preload("res://Workshop/Rooms/Regional Release/UI/item_target.gd")
const Drag = preload("res://Workshop/Rooms/Regional Release/UI/drag_context.gd")
const MapWorld = preload("res://Workshop/Rooms/Regional Release/World/map_world.gd")
const Travel = preload("res://Workshop/Rooms/Regional Release/World/travel_cost.gd")
var map_world = null
var active_map = null
