extends "res://Workshop/Rooms/Regional Release/UI/game_ui.gd"
const Simulation = preload("res://Workshop/Rooms/Regional Release/Actors/actor_world.gd")
const Brain = preload("res://Workshop/Rooms/Regional Release/Actors/enemy_brain.gd")
const ActorView = preload("res://Workshop/Rooms/Regional Release/UI/actor_view.gd")
