...
const SECTIONS: Array = [
	...
	["Inventory and belts", "Drag items between backpack, equipment, belt pouches and available loot targets. Shift-left-click backpack potions to fill the next free equipped belt pouch. Shift-left-click backpack equipment to equip it; Shift-left-click worn gear to unequip it. Right-click a carried belt and choose Empty belt to move all potions to the backpack. It refuses if they will not all fit. During an item drag, R or right-click rotates the item."],
