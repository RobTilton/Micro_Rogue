...
const Pois = preload("res://Workshop/Rooms/UI Foundation/Prototype/domain/local_poi_placement.gd")
...
const ARCHIVES: String = "res://Workshop/Rooms/World Foundation/saves/"
...
func declare(id: String, parent: String, template: String, label: String, constraints: Dictionary) -> void:
	assert(not records.has(id) and records.has(parent) and not Templates.get_template(template).is_empty(),"Workshop/Rooms/World Foundation/domain/location_world.gd: invalid location declaration")
...
func ensure_location(id: String):
	...
	if not records.has(id):
		push_error("Workshop/Rooms/World Foundation/domain/location_world.gd: unknown location " + id)
		return null
...
func read_state(id: String) -> Dictionary:
	...
	if not archives.has(id):
		push_error("Workshop/Rooms/World Foundation/domain/location_world.gd: missing generated state " + id)
		return {}
