extends "res://Workshop/Rooms/Actor Foundation/ui/actor_game.gd"
const Persistent = preload("res://Workshop/Rooms/World Foundation/domain/persistent_actor_world.gd")
...
func _save_paths() -> Array[String]:
	...
	for directory: String in [Persistent.SAVE_DIR,autosave_directory]:
...
func _save_world() -> void:
	var outcome: Dictionary = simulation.save_game()
	_note(outcome.reason)
	_refresh()
