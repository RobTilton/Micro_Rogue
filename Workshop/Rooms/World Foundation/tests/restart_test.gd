...
func check(value: bool, message: String) -> void:
	...
	if not value:
		failures += 1
		push_error("Workshop/Rooms/World Foundation/tests/restart_test.gd: "+message)
func _initialize() -> void:
	var path: String = FileAccess.get_file_as_string("res://Workshop/Rooms/World Foundation/tests/restart_path.txt")
	var sim = Sim.new(1)
	...
	saved = sim.save_game("res://Workshop/Rooms/World Foundation/tests/saves/")
