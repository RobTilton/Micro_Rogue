extends Control
const Cooldowns = preload("res://Workshop/Rooms/UI Foundation/Prototype/gameplay/cooldowns.gd")
...
const Board = preload("res://Workshop/Rooms/UI Foundation/Prototype/gameplay/hex_board.gd")
const DieSlot = preload("res://Workshop/Rooms/UI Foundation/Prototype/gameplay/die_slot.gd")
const SplashArt = preload("res://Workshop/Rooms/UI Foundation/Prototype/splash/splash_art.gd")
