extends "res://Workshop/Rooms/UI Foundation/Prototype/gameplay/hex_board.gd"
...
const MarshArt = preload("res://Workshop/Rooms/UI Foundation/Prototype/ui/marsh_art.gd")
...
func _ready() -> void:
	...
	water_texture = load("res://Workshop/Chad-Casso/Ocean_And_Lake_Tiles.png") as Texture2D
	for biome: String in ["Plains","Forest","Hills","Mountains","Desert"]:
		local_textures[biome] = load("res://Workshop/Chad-Casso/Local_Map_"+biome+".png") as Texture2D
	poi_texture = load(PoiArt.SHEET) as Texture2D
	biome_texture = load("res://Workshop/Chad-Casso/OVERWORLD_TILES_BIOME.png") as Texture2D
