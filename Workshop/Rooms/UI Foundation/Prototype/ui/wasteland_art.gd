...
const SHEETS: Array[String] = ["res://Workshop/Chad-Casso/Local_Map_Wasteland_DO_NOT_USE_THE_ROADS.png","res://Workshop/Chad-Casso/Local_Map_Wasteland_02.png"]
...
static func sample(cell: Vector2i, map_id: String) -> Vector3:
	return SAMPLES[posmod((map_id+":"+str(cell)).hash(),SAMPLES.size())]
