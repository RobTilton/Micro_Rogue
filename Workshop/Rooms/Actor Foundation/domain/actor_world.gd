extends RefCounted
const Maps = preload("res://Workshop/Rooms/UI Foundation/Prototype/domain/map_world.gd")
...
const Clock = preload("res://Workshop/Rooms/UI Foundation/Prototype/gameplay/cooldowns.gd")
const Sight = preload("res://Workshop/Rooms/Actor Foundation/domain/perception.gd")
var maps: RefCounted
