extends SceneTree
const Sim = preload("res://Workshop/Rooms/Actor Foundation/domain/actor_world.gd")
const Brain = preload("res://Workshop/Rooms/Actor Foundation/domain/enemy_brain.gd")
const Actor = preload("res://Workshop/Rooms/UI Foundation/Prototype/gameplay/actors.gd")
...
func check(value: bool, description: String) -> void:
	checks += 1
	if not value:
		push_error("Workshop/Rooms/Actor Foundation/tests/actor_simulation_test.gd: " + description)
		failures += 1
func fixture() -> void:
	world.actors.clear()
...
func _initialize() -> void:
	...
	print("Workshop/Rooms/Actor Foundation/tests/actor_simulation_test.gd: %d checks, %d failures" % [checks,failures])
