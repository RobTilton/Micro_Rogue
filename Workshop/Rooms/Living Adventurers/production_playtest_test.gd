...
func run() -> void:
	...
	game.autosave_directory = "res://Workshop/Rooms/Living Adventurers/Tests/production_ui/autosaves/"
	game.snapshot_directory = "res://Workshop/Rooms/Living Adventurers/Tests/production_ui/snapshots/"
	game.preferences_path = "res://Workshop/Rooms/Living Adventurers/Tests/production_ui/preferences.cfg"
	root.add_child(game)
