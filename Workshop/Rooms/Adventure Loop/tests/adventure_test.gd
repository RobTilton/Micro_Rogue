...
func run() -> void:
	...
	var dir: String = "res://Workshop/Rooms/Adventure Loop/tests/saves/"
	...
	if DisplayServer.get_name() != "headless":
		...
		root.get_texture().get_image().save_png("res://Workshop/Rooms/Adventure Loop/tests/sidebar.png")
	game.queue_free()
	await process_frame
	print("Adventure Loop: %d checks, %d failures" % [checks,failures])
