extends RefCounted
const HexMap = preload("res://Workshop/Rooms/Regional Foundation/World/hex_map.gd")
const Biomes = preload("res://Workshop/Rooms/Regional Foundation/World/biome_generator.gd")
const Continents = preload("res://Workshop/Rooms/Regional Foundation/World/continent_generator.gd")
const LocalTerrain = preload("res://Workshop/Rooms/Regional Foundation/World/local_terrain.gd")
...
const LocalPois = preload("res://Workshop/Rooms/Regional Foundation/World/local_poi_placement.gd")
var world_seed: int
var maps: Dictionary = {}
