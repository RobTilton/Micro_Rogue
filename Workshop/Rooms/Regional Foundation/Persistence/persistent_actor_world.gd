extends "res://Workshop/Rooms/Regional Foundation/Actors/actor_world.gd"
const Locations = preload("res://Workshop/Rooms/Regional Foundation/World/location_world.gd")
...
const MapState = preload("res://Workshop/Rooms/Regional Foundation/Persistence/map_state.gd")
