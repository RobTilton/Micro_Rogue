extends "res://Workshop/Rooms/Regional Foundation/UI/base_game.gd"
const Card = preload("res://Workshop/Rooms/Regional Foundation/UI/item_card.gd")
...
const Paths = preload("res://Workshop/Rooms/Regional Foundation/World/movement_preview.gd")
const Parts = preload("res://Workshop/Rooms/Regional Foundation/UI/ui_parts.gd")
const Rail = preload("res://Workshop/Rooms/Regional Foundation/UI/navigation_rail.gd")
const Host = preload("res://Workshop/Rooms/Regional Foundation/UI/panel_host.gd")
const Hud = preload("res://Workshop/Rooms/Regional Foundation/UI/bottom_hud.gd")
const World = preload("res://Workshop/Rooms/Regional Foundation/UI/world_view.gd")
const BackpackGrid = preload("res://Workshop/Rooms/Regional Foundation/UI/inventory_grid.gd")
const Target = preload("res://Workshop/Rooms/Regional Foundation/UI/item_target.gd")
const Drag = preload("res://Workshop/Rooms/Regional Foundation/UI/drag_context.gd")
const MapWorld = preload("res://Workshop/Rooms/Regional Foundation/World/map_world.gd")
const Travel = preload("res://Workshop/Rooms/Regional Foundation/World/travel_cost.gd")
var map_world = null
var active_map = null
