extends "res://Workshop/Rooms/Regional Foundation/UI/actor_game.gd"
const Persistent = preload("res://Workshop/Rooms/Regional Foundation/Persistence/persistent_actor_world.gd")
