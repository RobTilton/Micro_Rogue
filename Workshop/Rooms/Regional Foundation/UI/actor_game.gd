extends "res://Workshop/Rooms/Regional Foundation/UI/game_ui.gd"
const Simulation = preload("res://Workshop/Rooms/Regional Foundation/Actors/actor_world.gd")
const Brain = preload("res://Workshop/Rooms/Regional Foundation/Actors/enemy_brain.gd")
const ActorView = preload("res://Workshop/Rooms/Regional Foundation/UI/actor_view.gd")
