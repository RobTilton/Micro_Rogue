extends Control
const Cooldowns = preload("res://Workshop/Rooms/Regional Foundation/Actors/cooldowns.gd")
...
const Board = preload("res://Workshop/Rooms/Regional Foundation/UI/hex_board.gd")
const DieSlot = preload("res://Workshop/Rooms/Regional Foundation/UI/die_slot.gd")
const SplashArt = preload("res://Workshop/Rooms/Regional Foundation/UI/splash_art.gd")
