extends SceneTree
const Sim = preload("res://Workshop/Rooms/Regional Foundation/Actors/actor_world.gd")
const Brain = preload("res://Workshop/Rooms/Regional Foundation/Actors/enemy_brain.gd")
const Actor = preload("res://Workshop/Rooms/Regional Foundation/Actors/actors.gd")
const Items = preload("res://Workshop/Rooms/Regional Foundation/Actors/items.gd")
...
func check(value: bool, description: String) -> void:
	checks += 1
	if not value:
		push_error("Workshop/Rooms/Regional Foundation/tests/actor_simulation_test.gd: " + description)
		failures += 1
func fixture() -> void:
	world.actors.clear()
...
func _initialize() -> void:
	...
	print("Workshop/Rooms/Regional Foundation/tests/actor_simulation_test.gd: %d checks, %d failures" % [checks,failures])
