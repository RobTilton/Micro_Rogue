...
func check(value: bool, message: String) -> void:
	...
	if not value:
		failures += 1
		push_error("Workshop/Rooms/Regional Foundation/tests/world_ui_test.gd: "+message)
...
func run() -> void:
	...
	game.autosave_directory = "res://Workshop/Rooms/Regional Foundation/tests/saves/autosaves/"
	...
	root.get_texture().get_image().save_png("res://Workshop/Rooms/Regional Foundation/tests/local_gameplay.png")
	...
	var saved: Dictionary = game.simulation.save_game("res://Workshop/Rooms/Regional Foundation/tests/saves/")
